...
export default function App({ Component, pageProps }) {
  ...
  useEffect(() => {
    ...
    console.log(
      '%cHey explorer!, Are you lost?? Because this is not the right place for you. If you want to work with us at HackElite contact us now.',
  ...
  return (
    <>
      <Head>
        ...
        <title>NoteKaro - Keep note and share your notes and links</title>
      </Head>
